...
class PersonInfo extends Component{
	...
	my_Icon=()=>{
		if(this.props.loginStore.isLoading===false){
			console.log("http://www.hawlover.club:8081/ssm/images/touxiang/"+this.props.loginStore.CurrentUserImg);
			return ("http://www.hawlover.club:8081/ssm/images/touxiang/"+this.props.loginStore.CurrentUserImg);
		}else {
